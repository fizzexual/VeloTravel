@echo off
REM Generate Android keystore for signing APKs
...
echo       Run: certutil -encode velotravel-release.keystore keystore.txt
echo       Then copy content (remove header/footer lines)
echo.
